...
#' 
#' RAnEn::verifySpreadSkill calculates the binned spread skill correlation between ensemble spread
#' and error.
#' 
...
#' @md
#' @export
verifyBinnedSpreadSkill <- function(anen.ver, obs.ver, boot=F, R=1000, intervals = 13, na.rm=T) {
